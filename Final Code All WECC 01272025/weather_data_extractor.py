...
def get_weather_data(year, month, day, latitude, longitude, model="ACCESS-CM2", scenarios=("historical", "ssp585"), variables=("hurs", "huss", "pr", "rlds", "rsds", "sfcWind", "tas", "tasmax", "tasmin"), lat_start=-59.875, lon_start=0.125, lat_step=0.25, lon_step=0.25):
